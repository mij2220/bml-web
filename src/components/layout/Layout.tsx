        ...
        <div className="p-3 border-t border-slate-100 flex-shrink-0">
          <div className="flex items-center gap-3 px-2 py-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-500 capitalize">{(user as any)?.designation_name || (user?.role === 'hr_admin' ? 'Admin' : user?.role?.replace('_', ' '))}</p>
            </div>
          ...
          {!isMobile && (
            <div className="flex items-center gap-2">
              ...
              <div className="hidden md:block">
                ...
                <p className="text-xs text-slate-500 mt-0.5 capitalize">{(user as any)?.designation_name || (user?.role === 'hr_admin' ? 'Admin' : user?.role?.replace('_', ' '))}</p>
              </div>
